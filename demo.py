...
image_path = "C:/Users/Avanthi/Downloads/output (14).jpg"
...
st.markdown(
    f"""
    <style>
    /* Left-side background image with blur */
    .left-image::before {{
        content: "";
        position: fixed;
        top: 0;
    ...
    /* Container for left column content */
    .col-left {{
        padding-left: 1.5rem;
        padding-top: 2rem;
        text-align: left;
...
with col2:
    if page == "📘 Project Introduction":
        ...
        **Food wastage** is a significant issue, with many households and restaurants discarding surplus food while numerous people struggle with food insecurity.
        ...
        csv_files = {
            "Receivers": "C:/Users/Avanthi/Downloads/receivers_data.csv",
            "Providers": "C:/Users/Avanthi/Downloads/providers_data.csv",
            "Food listings": "C:/Users/Avanthi/Downloads/food_listings_data.csv",
            "Claims": "C:/Users/Avanthi/Downloads/claims_data.csv"
        }
        ...
        cursor.execute(questions[selected_question])
